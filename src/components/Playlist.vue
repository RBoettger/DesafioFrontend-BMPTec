  ...
  <div class="container-principal">
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
      <div class="container-fluid w-100">
        <div
          class="collapse navbar-collapse d-flex justify-content-center w-100"
        >
    ...
    <div
      v-if="exibirHistorico"
      class="container mt-4 d-flex justify-content-center"
    >
      <div class="w-75">
        <h3 class="text-center mb-4">Histórico de Buscas</h3>
        <table class="table table-striped table-bordered">
          ...
          <tbody>
            <tr v-for="item in historico" :key="item.id">
              ...
              <td>
                <pre>{{ formatJson(item.resultadoJson) }}</pre>
              </td>
            </tr>
          </tbody>
        </table>
    ...
    <div
      ...
      v-if="!exibirHistorico && !exibirGeneros"
    >
      <div class="w-75">
        <table class="table table-striped table-bordered">
          <thead>
          ...
          <tbody>
            <tr v-for="(artista, index) in artistasExibidos" :key="index">
              <td v-if="!exibirGeneros">
                {{ artista.artist || "Desconhecido" }}
              </td>
              <td v-if="!exibirGeneros">
                {{ artista.song || "Desconhecida" }}
              </td>
    ...
    >
      <div class="w-75">
        <h3 class="text-center mb-4">Gêneros Musicais</h3>
        <ul class="list-group">
          <li
  ...
  methods: {
    async buscarPlaylists() {
      try {
        ...
        this.artistasOrdenados = [...this.artistas].sort((a, b) =>
